Notes:
- index.html is the entry point for this java documentation
- inside the Package it.polito.thermostat.controllermd.services there is the bulk of the main logic
